  ...
  if ($(".schedule-tab").length) {
    $(".schedule-tab .schedule-tab-btns .p-tab-btn").on("click", function (e) {
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".schedule-tab .schedule-tab-btns .p-tab-btn").removeClass(
          "active-btn"
        );
        $(this).addClass("active-btn");
...
// Include external HTML components
(function () {
  "use strict";
  ...
  // Initialize header-related interactions when header is already in the DOM
  function initializeHeaderInteractions() {
    // Sidebar toggle
    $(".navSidebar-button").on("click", function (e) {
      e.preventDefault();
      $(".xs-sidebar-group").addClass("is-active");
    });

    $(".close-side-widget, .xs-overlay").on("click", function (e) {
      e.preventDefault();
      $(".xs-sidebar-group").removeClass("is-active");
    });
    ...
    setTimeout(function () {
      ...
      var pageMap = {
        ...
        "about.html": "nav-item-about",
        "gallery.html": "nav-item-gallery",
        "event.html": "nav-item-event",
        "contact.html": "nav-item-contact",
      };

      var navClass = pageMap[currentPage];
      if (navClass) {
  ...
  //     // Reinitialize footer scripts if needed
  //     if (typeof scrollToTarget !== "undefined") {
  //       scrollToTarget();
  //     }

  //     // Reinitialize all owl carousels after footer loads
  //     if (typeof $ !== "undefined" && $.fn.owlCarousel) {
  //       // Only reinitialize if carousel exists and hasn't been initialized
  //       if (
  //         $(".four-item-carousel").length &&
  //         !$(".four-item-carousel").hasClass("owl-loaded")
  //       ) {
  //         $(".four-item-carousel").owlCarousel({
  //           loop: true,
  //           margin: 30,
