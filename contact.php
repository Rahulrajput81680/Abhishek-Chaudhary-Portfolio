                        ...
                        <div class="inner-content">
                            <div class="two-column-carousel owl-carousel owl-theme owl-nav-none">
                                ...
                                <div class="single-item">
                                    ...
                                    <ul class="info clearfix">
                                        <li>
                                            <p><a href="tel:4488801234">101</a><br />
                                        </li>
                                        <li>
                                ...
                                <div class="single-item">
                                    <h4>Ambulance / Medical Department</h4>
                                    <ul class="info clearfix">
                                        <li>
                                            <p><a href="tel:4488848018">102 / 108 </a>
                                        </li>
                                        <li>
                                            <p>Medical Emergency / Ambulance</p>
                                        </li>
                                    </ul>
                                    <!-- <div class="link"><a href="contact.html">Get Direction<i class="flaticon-right-arrow"></i></a></div> -->
                                </div>
                                <div class="single-item">
                                    <h4>Women Safety Department</h4>
                                    <ul class="info clearfix">
                                        <li>
                                            <p><a href="tel:4488801234">1091</a><br />
                                        </li>
                                        <li>
                                            <p>Women Safety Department</p>
                                        </li>
                                    </ul>
                                    <!-- <div class="link"><a href="contact.html">Get Direction<i class="flaticon-right-arrow"></i></a></div> -->
                                </div>
                                <div class="single-item">
                                    <h4>Child Protection Department</h4>
                                    <ul class="info clearfix">
                                        <li>
                                            <p><a href="tel:4488848018">1098</a><br />
                                        </li>
                                        <li>
                                            <p>Child Helpline</p>
                                        </li>
                                ...
                                <div class="single-item">
                                    <h4>Senior Citizen Support Department</h4>
                                    <ul class="info clearfix">
                                        <li>
                                            <a href="tel:4488801234">14567</a><br />
                                        </li>
                                        <li>
                                            <p>Elder Helpline</p>
                                        </li>
