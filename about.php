                ...
                <div class="row clearfix align-items-center">
                    <div class="col-lg-4 col-md-12 col-sm-12 content-column">
                        <div class="content_block_5">
                            <div class="content-box">
                                <div class="sec-title">
                                    <h6><i class="flaticon-star"></i><span>About us</span></h6>
                                    <h2>Building a better tomorrow, starting today</h2>
                                ...
                                <div class="text">
                                    ...
                                    <ul class="list clearfix">
                                        ...
                                        <li><i class="flaticon-bird"></i>Digital and smart community development</li>
                                        <li><i class="flaticon-bird"></i>Clean & Green society</li>
                                        <li><i class="flaticon-bird"></i>Education empowerement</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <section class="discover-section sec-pad" style="background-image: url(assets/images/background/discover-bg.jpg);">
            <div class="auto-container">
                <div class="sec-title centred light">
                    ...
                    <h2>Principles That Shape Our Leadership</h2>
                    <div class="title-shape"></div>
                </div>
        ...
        <section class="feature-section sec-pad" style="background-image: url(assets/images/background/feature-bg.jpg);">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <h2>More About Our Mission for the People</h2>
                    <div class="title-shape"></div>
                </div>
                <div class="row clearfix">
