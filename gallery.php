        ...
        <section class="portfolio-section sec-pad">
            <div class="auto-container">
                <div class="sec-title centred">
                    <h6><i class="flaticon-star"></i><span>Gallery</span><i class="flaticon-star"></i></h6>
                ...
                <div class="sortable-masonry">
                            ...
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <!-- <div class="text">
                                            <p>[ Tourist Guide ]</p>
                                            <h4><a>Ancient Roman Sculpture</a></h4>
                                        </div> -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- <div class="more-btn centred"><a href="gallery.html" class="theme-btn">Load More</a></div> -->
                </div>
            </div>
        </section>
